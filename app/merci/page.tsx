  ...
  return (
    <section className="bloc flex min-h-[70vh] items-center pt-[150px]">
      <div className="cadre-sm">
        ...
        <h1 className="titre-2 mt-6">Je te réponds sous 72 heures.</h1>
        <p className="corps mt-7">
          ...
          correspond, on cale un premier échange. Si ce n'est pas le bon moment, je te le dis franchement — et je te dis
          pourquoi.
        </p>
